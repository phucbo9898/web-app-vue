<template>
    <div class="border border-radius-10 p-3">
        ...
        <!-- <div>
            <input type="file" name="image" @change="uploadChange">
        </div> -->
        <ValidationObserver v-slot="{ handleSubmit, invalid }">
                    ...
                    >
                        ...
                        <div class="d-flex mt-2">
                            ...
                            <div class="col-md-9 ml-10" style="width: 150px !important;">
                                <img :src="newAvatar ? newAvatar : $store.state.userInfor.user.avatar" alt="" width="100%">
                            </div>
                        </div>
            ...
            <div class="px-3 d-flex">
                <div class="col-md-3"></div>
                <div class="col-md-9 ml-10">
                    <button @click="handleSubmit(handleChangeProfile)" class="btn btn-primary">Submit</button>
                </div>
            </div>
        </ValidationObserver>
...
export default class SettingInformation extends Vue {
    ...
    uploadChange(event: any) {
        ...
        if (event.target.files[0].size > 26214400) { // 25MB
